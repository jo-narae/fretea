<template>
  <div class="image-area">
    ...
    <div class="prev-next-area">
      <button class="arrow arrow-left arrow-disable" @click="prev">
    ...
    <div class="black-cover">
      <div class="image-wrapper">
        <div role="listbox" class="image-listbox">
...
export default {
  ...
  methods: {
    ...
    next() {
      console.log(document.querySelector('.prev-next-area').offsetWidth);
    },
  },
  mounted() {
    this.imageWidth = document.querySelector('.prev-next-area').offsetWidth;
  }
}
</script>
